...
const Maps = () => {
  const maps = [
    { 
      ...
      image: '/frontend/public/images/maps_processed/dust2/Cs2_dust2_overview.png'
    },
    { 
      name: 'Mirage', 
      description: '中东风格地图，以复杂的巷道系统和中央宫殿为特色。',
      image: '/frontend/public/images/maps_processed/mirage/Cs2_mirage_radar.png'
    },
    { 
      name: 'Inferno', 
      description: '意大利小镇地图，以狭窄的巷道和香蕉道闻名。',
      image: '/frontend/public/images/maps_processed/inferno/CS2_inferno_radar.png'
    },
    { 
      name: 'Nuke', 
      description: '核电站地图，以垂直战斗和复杂的室内外转换著称。',
      image: '/frontend/public/images/maps_processed/nuke/Cs2_nuke_radar.png'
    },
    { 
      name: 'Anubis', 
      description: '埃及主题地图，以金字塔和古埃及建筑为特色。',
      image: '/frontend/public/images/maps_processed/anubis/De_anubis_radar.png'
    },
    { 
      name: 'Ancient', 
      description: '玛雅文明地图，以丛林环境和古代遗迹为特色。',
      image: '/frontend/public/images/maps_processed/ancient/Ancient_Radar.png'
    }
  ];
